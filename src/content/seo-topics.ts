...
export const seoTopics: Record<Locale, Record<SeoTopicSlug, SeoTopicCopy>> = {
  az: {
    "football-social-network": {
      ...
      description: "PeerFootball-də futbol profili yaradın, paylaşımlar edin, dostlar tapın və yerli futbol icmanızla əlaqədə qalın.",
      eyebrow: "Futbol sosial şəbəkəsi",
      answer: "PeerFootball futbolçular, azarkeşlər və yerli klublar üçün yaradılmış futbol sosial şəbəkəsidir. Ümumi sosial platformalardan fərqli olaraq profil, lent, dostluq, klub və oyun funksiyaları eyni futbol kimliyi ətrafında birləşir.",
      ...
      stepsTitle: "PeerFootball-də necə başlamaq olar?",
      ...
      faq: [
        ...
        { question: "PeerFootball-də foto və video paylaşmaq olar?", answer: "Bəli. Lent mətn, foto və video paylaşımlarını, həmçinin şərh, bəyənmə və təkrar paylaşmanı dəstəkləyir." }
      ]
    },
    "local-football-match-organizer": {
      title: "Yerli futbol oyunlarını onlayn təşkil edin",
      description: "PeerFootball ilə yerli futbol oyununu planlaşdırın, məkan və vaxtı təyin edin, tərəfləri qurun və nəticəni saxlayın.",
      eyebrow: "Yerli oyun təşkilatçısı",
      answer: "PeerFootball yerli futbol oyununu planlaşdırmaq və klub üzvləri ilə idarə etmək üçün vahid iş axını verir. Oyun vaxtını və məkanını qeyd edin, tərəfləri formalaşdırın, nəticəni təsdiqləyin, qolları və videoları oyun tarixçəsində saxlayın.",
      ...
      faq: [
        { question: "PeerFootball hansı futbol oyunlarını dəstəkləyir?", answer: "PeerFootball klubdaxili və klublararası oyunların yaradılmasını və idarəsini dəstəkləyir." },
    ...
    "find-football-players": {
      ...
      description: "PeerFootball-də oyunçu profillərini axtarın, dostluq qurun və növbəti yerli oyun üçün futbolçularla danışın.",
      eyebrow: "Futbolçu axtarışı",
      answer: "PeerFootball yerli futbol icmasında oyunçuları tapmağı və onlarla əlaqə qurmağı asanlaşdırır. Oyunçu profillərinə baxın, axtarışdan istifadə edin, dostluq göndərin və uyğun komanda yoldaşları ilə birbaşa danışın.",
      ...
      faq: [
        { question: "PeerFootball futbolçu tapmağa kömək edirmi?", answer: "Bəli. Axtarış, oyunçu profilləri, dostluqlar və mesajlar futbolçuları kəşf etməyə və əlaqə qurmağa kömək edir." },
        { question: "Oyunçu ilə birbaşa danışmaq olar?", answer: "Qəbul edilmiş dostluqdan sonra PeerFootball-in birbaşa mesajlaşma funksiyasından istifadə etmək olar." }
      ]
    },
    "football-club-management": {
      title: "Yerli futbol klubu və heyət idarəetməsi",
      description: "PeerFootball-də futbol klubu yaradın, üzvləri və rolları idarə edin, oyunlar planlaşdırın və klub göstəricilərini izləyin.",
      eyebrow: "Futbol klubu idarəetməsi",
      answer: "PeerFootball yerli futbol klublarına üzvləri, rolları, qonaqları və oyunları bir mərkəzdən idarə etməyə kömək edir. Klub sahibləri dəvətlər göndərə, idarəçi səlahiyyətləri verə və klub fəaliyyətini izləyə bilərlər.",
      ...
      faq: [
        { question: "PeerFootball-də futbol klubu yaratmaq olar?", answer: "Bəli. İstifadəçilər klub yarada, oyunçuları dəvət edə və üzvlük prosesini idarə edə bilərlər." },
  ...
  en: {
    "football-social-network": {
      ...
      description: "Build a football profile, share posts, find friends, and stay connected with your local football community on PeerFootball.",
      eyebrow: "Football social network",
      answer: "PeerFootball is a football social network built for players, fans, and local clubs. Instead of separating social posts from real football activity, it connects profiles, the community feed, friendships, clubs, and local matches around one football identity.",
      ...
      stepsTitle: "How do you get started on PeerFootball?",
      ...
      faq: [
        ...
        { question: "Can I share football photos and videos?", answer: "Yes. The PeerFootball feed supports text, photo, and video posts alongside comments, likes, and reposts." }
      ]
    },
    "local-football-match-organizer": {
      title: "Organize local football matches online",
      description: "Plan a local football match, set the venue and time, build the sides, and record the result with PeerFootball.",
      eyebrow: "Local match organizer",
      answer: "PeerFootball provides one workflow for organizing a local football match with club members. Set the time and venue, form the sides, confirm the result, and keep goals and match videos attached to the match history.",
      ...
      faq: [
        { question: "What football match formats does PeerFootball support?", answer: "PeerFootball supports the creation and management of internal club games and club-versus-club fixtures." },
    ...
    "find-football-players": {
      ...
      description: "Search player profiles, make football friends, and message players for your next local game on PeerFootball.",
      eyebrow: "Find football players",
      answer: "PeerFootball makes it easier to find and contact players in a football-focused community. Browse player profiles, use search, send a friendship request, and speak directly with suitable teammates before the next local game.",
      ...
      faq: [
        { question: "Does PeerFootball help me find football players?", answer: "Yes. Search, player profiles, friendships, and messages help people discover and connect with footballers." },
        { question: "Can I message a player directly?", answer: "After a friendship request is accepted, the players can use PeerFootball direct messaging." }
      ]
    },
    "football-club-management": {
      title: "Local football club and squad management",
      description: "Create a football club, manage members and roles, schedule matches, and track club metrics with PeerFootball.",
      eyebrow: "Football club management",
      answer: "PeerFootball helps local football clubs manage members, roles, guests, and matches from one shared place. Club owners can invite players, assign management permissions, and keep club activity organized without separating the squad from its match history.",
      ...
      faq: [
        { question: "Can I create a football club on PeerFootball?", answer: "Yes. Users can create a club, invite players, and manage membership." },
  ...
  ru: {
    "football-social-network": {
      ...
      description: "Создайте футбольный профиль, публикуйте контент, находите друзей и общайтесь с местным футбольным сообществом в PeerFootball.",
      eyebrow: "Футбольная социальная сеть",
      answer: "PeerFootball — футбольная социальная сеть для игроков, болельщиков и местных клубов. Она объединяет профили, публикации, друзей, клубы и местные матчи вокруг единой футбольной личности пользователя.",
      ...
      stepsTitle: "Как начать пользоваться PeerFootball?",
      ...
      faq: [
        ...
        { question: "Можно ли публиковать футбольные фото и видео?", answer: "Да. Лента PeerFootball поддерживает текст, фотографии и видео, а также комментарии, отметки и репосты." }
      ]
    },
    "local-football-match-organizer": {
      title: "Организуйте местные футбольные матчи онлайн",
      description: "Планируйте местный матч, указывайте место и время, формируйте составы и сохраняйте результат в PeerFootball.",
      eyebrow: "Организатор местных матчей",
      answer: "PeerFootball предоставляет единый процесс организации местного футбольного матча с участниками клуба. Укажите время и место, сформируйте составы, подтвердите результат и сохраните голы и видео в истории матча.",
      ...
      faq: [
        { question: "Какие форматы матчей поддерживает PeerFootball?", answer: "PeerFootball поддерживает внутренние игры клуба и межклубные матчи." },
    ...
    "find-football-players": {
      ...
      description: "Ищите профили игроков, добавляйте футбольных друзей и общайтесь перед следующим местным матчем в PeerFootball.",
      eyebrow: "Поиск футболистов",
      answer: "PeerFootball упрощает поиск игроков и общение с ними в футбольном сообществе. Просматривайте профили, используйте поиск, отправляйте запросы в друзья и напрямую обсуждайте следующий местный матч.",
      ...
      faq: [
        { question: "Помогает ли PeerFootball найти футболистов?", answer: "Да. Поиск, профили игроков, друзья и сообщения помогают находить футболистов и связываться с ними." },
        { question: "Можно ли написать игроку напрямую?", answer: "После принятия запроса в друзья игроки могут использовать личные сообщения PeerFootball." }
      ]
    },
    "football-club-management": {
      title: "Управление местным футбольным клубом и составом",
      description: "Создайте футбольный клуб, управляйте участниками и ролями, планируйте матчи и отслеживайте показатели в PeerFootball.",
      eyebrow: "Управление футбольным клубом",
      answer: "PeerFootball помогает местным футбольным клубам управлять участниками, ролями, гостями и матчами в одном месте. Владельцы клубов могут приглашать игроков, назначать управляющих и систематизировать активность клуба.",
      ...
      faq: [
        { question: "Можно ли создать футбольный клуб в PeerFootball?", answer: "Да. Пользователи могут создать клуб, приглашать игроков и управлять членством." },
