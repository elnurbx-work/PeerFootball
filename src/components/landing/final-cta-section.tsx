...
export function FinalCtaSection({ copy }: { copy: LandingCopy }) {
  return (
    <section className="bg-background px-5 pb-16 md:px-8 md:pb-24 lg:px-12">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-brand px-6 py-16 text-center text-white sm:px-10 md:py-20">
