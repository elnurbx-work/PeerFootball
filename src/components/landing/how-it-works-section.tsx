  ...
  return (
    <section className="landing-section bg-brand text-white">
      <div className="landing-container">
        ...
        <h2 className="mt-4 text-[clamp(2rem,9vw,4.25rem)] font-black leading-none tracking-[-0.045em] sm:tracking-[-0.055em]">{copy.steps.title}</h2>
        <ol className="mt-12 grid gap-0 sm:mt-14 md:grid-cols-3">
          {copy.steps.items.map((step, index) => (
            <li key={step.title} className="group relative min-w-0 border-l border-white/15 pb-10 pl-8 last:pb-0 sm:pl-10 md:border-l-0 md:border-t md:pb-0 md:pl-0 md:pr-10 md:pt-10">
