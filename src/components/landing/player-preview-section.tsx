  ...
  return (
    <section className="landing-section bg-card">
      <div className="landing-container grid items-center gap-12 lg:grid-cols-[.86fr_1.14fr]">
        ...
        <article className="overflow-hidden rounded-[1.75rem] border border-border bg-surface-muted shadow-[0_24px_70px_rgba(15,23,42,.1)]">
          <div className="relative bg-brand p-6 text-white sm:p-8">
            ...
            <div className="relative flex items-center gap-4">
              <span className="grid h-20 w-20 shrink-0 place-items-center rounded-[1.4rem] bg-gradient-to-br from-primary to-brand text-accent"><CircleUserRound className="h-11 w-11" /></span>
              <div><p className="text-xs font-bold uppercase tracking-widest text-accent">PeerFootball player</p><h3 className="mt-1 text-2xl font-black">Alex Morgan</h3><p className="mt-1 text-sm text-white/55"><MapPin className="mr-1 inline h-3.5 w-3.5" />Baku · {copy.player.position}</p></div>
